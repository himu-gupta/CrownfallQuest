...
- 38 deterministic local tests covering geometry, movement, jump timing, collisions, breakable blocks, power-ups, scoring, checkpoints, AI, projectiles, three boss phases, level validation, and progression.
